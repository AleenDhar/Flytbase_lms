          ...
          {wishlistedCourses.length > 0 ? (
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                ...
                <p className="text-sm text-muted-foreground">
                  {wishlistedCourses.length} courses saved for later
                </p>
              </div>
                  ...
                  >
                    ...
                    <div className="p-5 flex-1 flex flex-col">
                      ...
                      <div className="text-xs text-muted-foreground mb-4">
                        ...
                        <div className="mt-1">
                          Added on:{" "}
                          {new Date(course.wishlisted_at).toLocaleDateString()}
                        </div>
                      </div>
            ...
            <div className="text-center py-12 bg-muted/40 rounded-lg border border-border">
              ...
              <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                You haven't added any courses to your wishlist yet. Browse
                courses and click the heart icon to save them for later.
              </p>
              <Button asChild>
                <Link href="/course">Browse Courses</Link>
              </Button>
